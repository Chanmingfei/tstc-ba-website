...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const CHANGELOG_DATA = [
        { d: '2026-08-05', zh: [
            ...
            '【新增】新生指南（十二）-新生必备软件合集：整理大一新生手机里必备的刚需软件清单，覆盖上课学习（学习通、长江雨课堂、WakeUp 课程表）、英语三件套（U 校园、UTalk、iTEST）、校园学分（易班、到梦空间）、官方工具（EasyConnect、学信网、工商银行 APP）、AI 辅助（豆包 / DeepSeek / Kimi）与生活娱乐（美团 / 拼好饭、淘宝 / 拼多多）；EasyConnect 使用教程以 .glass-link 液态玻璃卡片跳转至学校图书馆公众号图文教程，并附软件图标合集、校园学习 / 外卖场景配图与 QQ 迎新群二维码'
        ], en: [
            ...
            '[New] Freshman Guide (12) – Essential Software Collection: a must-have app list for freshmen, covering class study (Xuexitong, Changjiang Rain Classroom, WakeUp Timetable), the English trio (U-Campus, UTalk, iTEST), campus credits (Yiban, Dao Meng Space), official tools (EasyConnect, CHSI, ICBC), AI aids (Doubao / DeepSeek / Kimi) and daily-life apps (Meituan / Pinhao Fan, Taobao / Pinduoduo); the EasyConnect tutorial uses a .glass-link Liquid Glass card jumping to the school library's illustrated WeChat guide, with a software-icon collage, campus study / takeout photos and the QQ freshman-group QR code'
        ]},
        { d: '2026-08-04', zh: [
    ...
    function buildRelated(meta) {
        ...
        function render(items) {
            ...
            related.forEach(function (item) {
                ...
                // 文章页位于 news/ 子目录，相关阅读链接需带 news/ 前缀（与首页卡片一致）
                card.href = basePath + 'news/' + item.slug + '.html';
